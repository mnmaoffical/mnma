        ...
        <div className="max-w-7xl mx-auto">
          {loading ? (
            <div className="flex justify-center py-20">
              <p className="text-gray-500 text-sm sm:text-base">{t('womens.loading')}</p>
            </div>
          ) : products.length === 0 ? (
            <div className="flex justify-center py-20">
              <p className="text-gray-500 text-sm sm:text-base">{t('womens.noProducts')}</p>
            </div>
          ) : (
                ...
                >
                  ...
                  <div className="space-y-1 p-4 sm:p-5">
                    ...
                    <div className="flex items-center justify-between gap-3 pt-1">
                      <p className="font-semibold text-base sm:text-lg">{formatPrice(product.price)}</p>
